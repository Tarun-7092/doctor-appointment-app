...
const Banner = () => {
  ...
  return (
    <div className='flex bg-indigo-500 rounded-lg px-6 sm:px-10 md:px-14 lg:px12 my-20 md:mx-10'>
      {/* -----------Left Side-------------- */}
      <div className='flex-1 py-10 sm:py-12 md:py-20 lg:md-30 lg:pl-5'>
